...
export const BLOG_POSTS = [
  {
    ...
    excerpt:
      "We put two AI models through their paces on 20 real-world tasks, from writing to coding, analysis, and creativity. The rundown includes honest scores and examples, plus we declare a clear winner for each use case.s",
...
// Ab ye sirf 4 clean categories generate karega: All, AI Tools, Web Tools, Digital Marketing, Productivity
