...
import { ArrowLeft, Search, ChevronDown, ArrowRight, Layout } from 'lucide-react'
...
const getToolEmoji = (path) => {
  ...
  if (path.includes('adsense') || path.includes('ad-revenue') || path.includes('cpm') || path.includes('cpc')) return '💰'
  ...
  if (path.includes('case-converter') || path.includes('uppercase')) return '🔤'
      ...
      <div className="flex-grow max-w-7xl mx-auto w-full px-5 sm:px-6 lg:px-8 pb-20">
        ...
        <div className="text-center mb-12 md:mb-16 pt-6">
          ...
          <p className="text-[15px] text-gray-500 max-w-3xl mx-auto leading-relaxed tracking-wide">
            Browse our complete collection of free browser-based tools including JSON formatter & validator, image compressor, QR code generator, password generator, word counter, Base64 encoder, and AI prompt builders. 100% free, no login, instant use.
          </p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-6 gap-y-3 mt-8 text-[13px] text-gray-500 tracking-wide">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-gray-700">{tools.length} Tools</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 bg-purple-500 rounded-full" />
              <span className="font-medium text-gray-700">{toolCategories.length} Categories</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        {selectedCategory !== "All" && !searchTerm.trim() && (
          <div className="mb-8 pb-6 border-b border-gray-200">
            ...
            <p className="text-[14px] text-gray-500 mt-1 tracking-wide">
              {filteredTools.length} tools available – click any tool to start using it instantly
            </p>
          </div>
        )}
