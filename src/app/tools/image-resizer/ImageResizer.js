...
export default function ImageResizer() {
  ...
  const resize = () => {
    ...
    const qual = FORMAT_OPTIONS.find((f) => f.value === fmt)?.hasQuality
      ? quality
      : undefined;
    canvas.toBlob(
      (blob) => {
      ...
      <div className="max-w-4xl mx-auto w-full px-4 pt-6">
        <nav aria-label="Breadcrumb">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li>
              <span className="text-gray-900 font-semibold">Image Resizer</span>
            </li>
          </ol>
        </nav>
      </div>
      ...
      <div className="flex-grow max-w-5xl mx-auto w-full px-4 pb-20">
        ...
        <div className="text-center mb-10 mt-4">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-2xl mx-auto">
            Change JPG, PNG and WebP to any pixel dimension or percentage.
            Platform presets for Instagram, YouTube, Twitter and more. No upload
            to server.
          </p>
        </div>
            ...
            <div className="space-y-5">
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-5">
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <span className="text-xs text-gray-400">
                        {formatBytes(originalSize)} · {origWidth}x{origHeight}px
                      </span>
                    </div>
                      ...
                      {resizedSize > 0 && (
                        <div className="mb-3 bg-gray-50 rounded-xl p-3 border border-gray-100">
                          <div className="flex justify-between text-xs text-gray-500 mb-1.5">
                            <span>
                              Original: {formatBytes(originalSize)} ({origWidth}
                              x{origHeight}px)
                            </span>
                            <span>
                              New: {formatBytes(resizedSize)} ({width}x{height}
                              px)
                            </span>
                          </div>
                          <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${Math.min(100, Math.max(5, 100 - Math.abs(savingsPct)))}%`,
                              }}
                            />
                          </div>
                        </div>
              ...
              {!originalImage && !error && (
                <div className="text-center py-16 text-gray-400 border-2 border-dashed border-gray-200 rounded-xl mt-4">
                  ...
                  <p>
                    Drop your image above or click to browse. We'll resize it to
                    your exact specs — no upload required.
                  </p>
                </div>
              )}
            </div>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            How to Resize Images for Social Media in 3 Simple Steps
          </h2>
          <ol className="space-y-5">
            {[
              {
                step: "1",
                title: "Pick a Platform Preset or Enter Custom Dimensions",
                desc: "Choose Instagram Post, YouTube Thumbnail, or any preset. Or type exact width/height in pixels. Toggle aspect ratio lock to prevent stretching.",
              },
              {
                step: "2",
                title: "Adjust Format & Quality",
                desc: "Select JPG for smallest files, PNG for transparency, or WebP for modern web optimization. Use the quality slider to balance file size vs visual fidelity.",
              },
              {
                step: "3",
                title: "Resize & Download",
                desc: "Click Resize Image. See original vs resized side by side with exact file sizes. Download instantly — no waiting, no upload.",
              },
            ].map((item) => (
          ...
          <div className="space-y-5">
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                We draw your image onto an invisible canvas at your target
                dimensions, then export the result. High-quality smoothing
                ensures sharp output even when resizing down.
              </p>
            </div>
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              <h3 className="font-bold text-gray-900 text-sm mb-2">
              ...
              <div className="bg-gray-900 text-green-400 font-mono text-sm px-4 py-3 rounded-xl mb-3 overflow-x-auto">
                locked: newH = newW × (origH / origW)
              </div>
              <p className="text-gray-500 text-xs leading-relaxed">
                When ratio is locked, changing width auto-calculates height (and
                vice versa) using the original image's proportions. Unlock to
                set exact non-proportional dimensions.
              </p>
            </div>
            <div className="bg-sky-50 border border-sky-100 rounded-xl p-4">
              ...
              <p className="text-sky-800 text-xs leading-relaxed">
                All resizing happens locally in your browser using JavaScript.
                No images are uploaded, stored, or sent anywhere. Close the tab
                and your data is gone. 100% private by design.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Real examples with different presets and formats.
          </p>
          <div className="space-y-5">
            <div className="border border-gray-100 rounded-2xl p-5">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-sm bg-pink-100 text-pink-700 font-bold px-2.5 py-1 rounded-lg">
            ...
            <div className="border border-gray-100 rounded-2xl p-5">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-sm bg-purple-100 text-purple-700 font-bold px-2.5 py-1 rounded-lg">
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            From creators to businesses — the right size makes content look
            professional.
          </p>
            ...
            {[
              {
                ...
                desc: "Resize product photos, team headshots, and promotional graphics to exact platform specs in seconds — no design skills needed.",
              },
              {
                icon: <FileText size={20} className="text-green-600" />,
                title: "Bloggers & Writers",
                desc: "Prepare featured images, inline graphics, and email headers at the exact pixel dimensions your CMS or newsletter requires.",
              },
              {
                icon: <Maximize2 size={20} className="text-amber-600" />,
                title: "E-commerce Sellers",
                desc: "Batch-resize product photos to platform requirements (Amazon, Shopify, Etsy) for consistent, professional-looking listings.",
              },
              {
                icon: <Shield size={20} className="text-violet-600" />,
                title: "Privacy-Conscious Users",
                desc: "Resize personal photos without uploading to third-party servers. Everything stays on your device — always.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Most online image resizers ask you to upload files to their servers.
            That means waiting for uploads, worrying about privacy, and
            sometimes dealing with watermarks or limits. Our free image resizer
            works differently — everything happens{" "}
            <strong>inside your browser</strong> using the HTML5 Canvas API.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Pick a preset like Instagram Post (1080x1080) or YouTube Thumbnail
            (1280x720) and the tool sets exact dimensions automatically. Keep
            aspect ratio locked to prevent distortion, or unlock for custom
            non-proportional sizing.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Output as JPG for smallest file size, PNG for transparency support,
            or WebP for modern web optimization. Quality slider lets you balance
            file size vs visual fidelity for lossy formats.
          </p>
            ...
            {[
              {
                ...
                desc: "Reduce image file size by up to 90% without quality loss.",
              },
              {
                href: "/tools/image-cropper",
                title: "Image Cropper",
                desc: "Crop images with social media presets and custom ratios.",
              },
              {
