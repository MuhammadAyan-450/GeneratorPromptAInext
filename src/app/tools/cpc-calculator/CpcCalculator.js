...
<<<<<<< HEAD
                  ...
                  <input type="number" step="0.01" placeholder="e.g. 500" value={cost} onChange={(e) => setCost(e.target.value)}
                ...
                <div>
                  ...
                  <input type="number" placeholder="e.g. 100" value={clicks} onChange={(e) => setClicks(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-gray-800" />
                </div>
              </>
            )}
            {mode === "cost" && (
              <>
                <div>
                  ...
                  <input type="number" step="0.01" placeholder="e.g. 2.50" value={cpc} onChange={(e) => setCpc(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-gray-800" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Total Clicks</label>
                  <input type="number" placeholder="e.g. 1000" value={clicks} onChange={(e) => setClicks(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-gray-800" />
                </div>
              </>
            )}
...
>>>>>>> 8da083c1a9a4babb5a845443cd94970488005ec2
          ...
          <div className="mb-6">
            <label className="block text-sm font-semibold text-gray-700 mb-2">
<<<<<<< HEAD
              Total Impressions <span className="text-gray-400 font-normal">(optional)</span>
            </label>
            <input type="number" placeholder="e.g. 10000" value={impressions} onChange={(e) => setImpressions(e.target.value)}
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent text-gray-800" />
            <p className="text-xs text-gray-500 mt-1">Add impressions to automatically calculate CTR and equivalent CPM alongside your CPC.</p>
          </div>
...
<<<<<<< HEAD
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            $50 and you convert 5% of clicks, you can afford up to $2.50 CPC
            to break even — anything below that is profit. This calculator helps
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            ...
            you're trying to find. All three are built into the calculator above.
          </p>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                ...
                clicks = <strong className="text-gray-700">$2,500 budget</strong>.
              </p>
            </div>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Pick your calculation mode, enter two values, and get your answer plus bonus metrics in one click.
          </p>
=======
        {/* Native ad here */}
...
<<<<<<< HEAD
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Three real-world examples showing how the CPC formula works in practice.
          </p>
            ...
            {[
              {
                ...
                inputs: [["Campaign Cost", "$750"], ["Total Clicks", "300"], ["Impressions", "15,000"]],
                formula: "CPC = $750 ÷ 300 = $2.50",
                result: "CPC: $2.50 | CTR: 2.0% | Equivalent CPM: $50.00 | Est. Conversions (3%): 9",
              ...
              },
              {
                ...
                inputs: [["CPC Rate", "$1.20"], ["Target Clicks", "5,000"]],
                formula: "Cost = $1.20 × 5,000 = $6,000",
                result: "Total Budget: $6,000 | Budget for 10,000 clicks: $12,000 | Est. Conversions (3%): 150",
              ...
              },
              {
                ...
                inputs: [["CPC Rate", "$0.85"], ["Campaign Budget", "$425"]],
                formula: "Clicks = $425 ÷ $0.85 = 500 clicks",
                result: "Total Clicks: 500 | Est. Impressions (2% CTR): 25,000 | Est. Conversions (3%): 15",
            ...
            <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
              <thead>
                <tr className="bg-gray-900 text-white">
                  ...
                  <th className="text-center px-4 py-3 font-semibold">Avg CPC Range</th>
                  <th className="text-center px-4 py-3 font-semibold">Notes</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ["Google Search Ads", "$1 – $10+", "Highly keyword-dependent"],
                  ["Google Display Network", "$0.30 – $1.50", "Lower intent, cheaper clicks"],
                  ["Facebook & Instagram", "$0.50 – $2.00", "Varies by audience targeting"],
                  ["LinkedIn Ads", "$5 – $15+", "Expensive but high B2B quality"],
                  ["Amazon Sponsored Products", "$0.50 – $1.50", "Strong purchase intent"],
                  ["Twitter / X Ads", "$0.30 – $1.00", "Lower competition"],
                  ["YouTube Ads (TrueView)", "$0.05 – $0.30", "Cost per view, not click"],
                  ["Microsoft / Bing Ads", "$0.80 – $5", "Often 20–30% cheaper than Google"],
                ].map((row, i) => (
            ...
            <table className="w-full text-sm border border-gray-200 rounded-xl overflow-hidden">
              <thead>
                <tr className="bg-gray-900 text-white">
                  ...
                  <th className="text-center px-4 py-3 font-semibold">Avg CPC (Google)</th>
                  <th className="text-center px-4 py-3 font-semibold">Why So High/Low</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ["Legal Services", "$6 – $50+", "High customer lifetime value"],
                  ["Insurance", "$8 – $40", "Fierce advertiser competition"],
                  ["Finance & Loans", "$5 – $30", "High conversion value per lead"],
                  ["Real Estate", "$3 – $15", "High transaction values"],
                  ["Healthcare", "$3 – $10", "Regulated but high demand"],
                  ["E-commerce (general)", "$0.50 – $3", "High volume, lower margin"],
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <Link href="/tools/cpm-calculator" className="text-sky-600 underline underline-offset-2 hover:text-sky-700">
              CPM Calculator
            </Link>{" "}
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Anyone running paid traffic — or planning to — needs to calculate CPC regularly.
=======
...
<<<<<<< HEAD
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              { href: "/tools/cpm-calculator", title: "CPM Calculator", desc: "Calculate cost per 1,000 impressions, campaign cost, or total impressions." },
              { href: "/tools/ad-revenue-calculator", title: "Ad Revenue Calculator", desc: "Estimate website ad income across 6 formats with CPM and CPC." },
              { href: "/tools/adsense-revenue-calculator", title: "AdSense Revenue Calculator", desc: "Estimate Google AdSense earnings by niche with real RPM data." },
              { href: "/tools/youtube-ad-revenue-calculator", title: "YouTube Revenue Calculator", desc: "Estimate YouTube ad income by video category and CPM." },
              { href: "/tools/percentage-calculator", title: "Percentage Calculator", desc: "Calculate percentage increases, decreases, and ratios." },
              { href: "/tools/profit-margin-calculator", title: "Profit Margin Calculator", desc: "Calculate profit margin and markup from cost and selling price." },
            ].map((tool) => (
