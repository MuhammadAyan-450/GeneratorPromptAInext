...
function crackTime(pwd) {
  ...
  const poolSize = charsets.reduce(
    (acc, c) => acc + (c.regex.test(pwd) ? c.size : 0),
    0,
  );
...
export default function PasswordGenerator() {
  ...
  const generateSingle = () => {
    if (passphraseMode) {
      const words = Array.from(
        { length: wordCount },
        () => WORDS[secureRandInt(WORDS.length)],
      );
      return words.join("-");
    }
  ...
  const copyText = () => {
    if (!password) return;
    const textToCopy =
      bulkPasswords.length > 1 ? bulkPasswords.join("\n") : password;
  ...
  const stats = passphraseMode
    ? [
        ...
        },
        {
          ...
          label: "Strength",
          colorClass: strength?.text || "text-gray-800",
        },
      ]
    : [
        {
      ...
      <div className="flex-grow max-w-4xl mx-auto w-full px-4 pb-20">
        ...
        <div className="text-center mb-10 mt-4">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-3">
            ...
            <span className="text-sky-600">
              Secure Password Maker with Strength Meter
            </span>
          </h1>
          <p className="text-gray-500 text-base md:text-lg max-w-2xl mx-auto">
            Create cryptographically secure passwords or memorable passphrases.
            Real-time strength meter, time-to-crack estimate, and bulk
            generation.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 md:p-10 mb-8">
          ...
          {!passphraseMode ? (
            <div className="space-y-5 mb-6">
              ...
              <label className="flex items-center gap-2 cursor-pointer text-sm text-gray-700">
                <input
                  ...
                  className="h-4 w-4 text-sky-600 rounded border-gray-300 focus:ring-sky-500"
                />
                Exclude ambiguous characters (0, O, l, 1, I) — easier to type
                manually
              </label>
            </div>
          ) : (
            <div className="mb-6">
              ...
              <p className="text-xs text-gray-400 mt-2">
                Example: <em>tiger-castle-river-lamp</em> — easy to remember,
                hard to crack
              </p>
            </div>
          )}
            ...
            <div className="flex gap-2 flex-wrap">
              {[
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-xl border text-sm font-medium transition-all ${bulkCount === m.value ? "bg-sky-600 text-white border-sky-600" : "bg-white text-gray-600 border-gray-200 hover:border-sky-400"}`}
                >
                  {m.label}
                </button>
              ))}
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            >
              <Shield size={18} /> Generate{" "}
              {passphraseMode ? "Passphrase" : "Password"}
            </button>
            <button
              onClick={reset}
          ...
          {!password && (
            <div className="text-center py-16 text-gray-400 border-2 border-dashed border-gray-200 rounded-xl mt-4">
              ...
              <p>
                Click{" "}
                <strong className="text-gray-500">Generate Password</strong> to
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            How to Generate a Strong Password in 3 Simple Steps
          </h2>
            ...
            {[
              {
                ...
                desc: "Pick Random Password for maximum security or Passphrase for memorable master passwords. Set length or word count using the slider.",
              },
              {
                step: "2",
                title: "Customize Settings",
                desc: "Enable character types (uppercase, lowercase, numbers, symbols) or exclude ambiguous characters for easier manual typing.",
              },
              {
                step: "3",
                title: "Generate & Secure",
                desc: "Click Generate. See real-time strength meter and crack time estimate. Copy or download your secure password instantly.",
              },
            ].map((item) => (
          ...
          <div className="space-y-5">
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                We use your browser's built-in cryptographic API to generate
                truly unpredictable random numbers. This is the same standard
                used by professional security tools — far more secure than
                Math.random().
              </p>
            </div>
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              ...
              <div className="bg-gray-900 text-green-400 font-mono text-sm px-4 py-3 rounded-xl mb-3 overflow-x-auto">
                score = length(6) + uppercase(1) + lowercase(1) + numbers(1) +
                symbols(2) → max 11
              </div>
              <p className="text-gray-500 text-xs leading-relaxed">
                Your password strength is calculated based on length, character
                variety, and symbol usage. The time-to-crack estimate shows how
                long a modern GPU cluster would take to brute-force your
                password.
              </p>
            </div>
            <div className="bg-sky-50 border border-sky-100 rounded-xl p-4">
              ...
              <p className="text-sky-800 text-xs leading-relaxed">
                All password generation happens locally in your browser using
                JavaScript. No passwords are uploaded, stored, or sent anywhere.
                Close the tab and your passwords are gone. 100% private by
                design.
              </p>
            </div>
          </div>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            What Kind of Passwords Can You Generate?
          </h2>
          <p className="text-gray-500 text-sm mb-6">
            Real examples with different modes and settings.
          </p>
          <div className="space-y-5">
              ...
              <div className="grid sm:grid-cols-3 gap-4 text-sm">
                <div className="bg-gray-50 rounded-lg p-3">
                  ...
                  <p className="font-semibold text-blue-600">
                    tiger-castle-river-lamp
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Strength</p>
                  <p className="font-semibold text-blue-600">Strong (78%)</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Best For</p>
                  <p className="font-semibold text-gray-800">
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            From individuals to teams — strong passwords protect everyone.
          </p>
            ...
            {[
              {
                ...
                desc: "Generate cryptographically secure passwords for banking, email, and crypto wallets. Real-time strength meter ensures maximum protection.",
              },
              {
                icon: <Shield size={20} className="text-green-600" />,
                title: "Password Manager Users",
                desc: "Create memorable passphrases for your master password. Easy to type, hard to crack — perfect for Bitwarden, 1Password, or KeePass.",
              },
              {
                icon: <Globe size={20} className="text-amber-600" />,
                title: "Developers & IT Teams",
                desc: "Generate bulk passwords for testing, staging environments, or team accounts. Download as .txt for secure offline distribution.",
              },
              {
                icon: <AlertCircle size={20} className="text-violet-600" />,
                title: "Privacy-Conscious Users",
                desc: "Generate passwords without uploading to third-party servers. Everything stays on your device — always.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Most online password generators ask you to paste settings into a web
            form that sends your request to their servers. That means waiting
            for responses, worrying about privacy, and sometimes dealing with
            ads or limits. Our free password generator works differently —
            everything happens <strong>inside your browser</strong> using the
            cryptographic API.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Choose between <strong>random passwords</strong> (maximum security
            with mixed characters) or <strong>memorable passphrases</strong>{" "}
            (random words joined by hyphens). The real-time strength meter and
            time-to-crack estimate give you instant feedback on how secure your
            password really is against modern GPU-based attacks.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Generate single passwords or bulk lists of 5 or 10 at once. Copy to
            clipboard with one click or download as a .txt file for offline use.
            Exclude ambiguous characters (0, O, l, 1, I) for easier manual
            typing.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            This tool runs 100% in your browser using JavaScript. No passwords
            are uploaded to any server. No data is stored or tracked. Your
            passwords stay on your device — always.
          </p>
          ...
          <div className="space-y-3 max-w-4xl mx-auto">
            {[
              ...
              },
              {
                ...
                a: "Yes. Once the page loads, all password generation happens locally in your browser. You can use it without an internet connection after the initial load.",
              },
            ].map((item, i) => (
              <div
                key={i}
            ...
            {[
              {
                ...
                desc: "Generate unique UUID v4 identifiers for secure tokens and database keys.",
              },
              {
                href: "/tools/base64-encode",
                title: "Base64 Encoder / Decoder",
                desc: "Encode and decode Base64 strings for secure data transmission.",
              },
              {
