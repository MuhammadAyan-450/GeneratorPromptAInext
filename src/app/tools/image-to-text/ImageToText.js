...
export default function ImageToText() {
  ...
  const runOCR = async (src) => {
    ...
    try {
      const { data } = await Tesseract.recognize(target, language, {
        logger: (m) => {
          ...
          if (m.status === "loading language traineddata") {
            setProgressLabel("Loading language...");
            setProgress(35);
          }
      ...
      setExtractedText(
        text || "No readable text detected. Try a clearer image.",
      );
      ...
      <div className="flex-grow max-w-5xl mx-auto w-full px-4 pb-20">
        ...
        <div className="text-center mb-10 mt-4">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-2xl mx-auto">
            Extract text from images, scanned documents and screenshots in 10+
            languages. Edit, copy or download the result. No server upload.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 md:p-10 mb-8">
          ...
          {!imageSrc ? (
            ...
            >
              ...
              <p className="text-gray-400 text-sm">
                JPG, PNG, WebP, BMP, TIFF — any image with text
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-5">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-5">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm font-semibold text-gray-700 flex items-center gap-2">
                      <ImageIcon size={15} className="text-sky-600" /> Uploaded
                      Image
                    </span>
                    <button
                      onClick={() => fileInputRef.current?.click()}
                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-5">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer mb-4">
                    ...
                    >
                      <span
                        className={`absolute top-0.5 w-4 h-4 bg-white rounded-full shadow transition-all ${autoRun ? "left-5" : "left-0.5"}`}
                      />
                    </div>
                ...
                <div className="bg-sky-50 border border-sky-100 rounded-2xl p-5">
                  <p className="text-sm font-semibold text-sky-900 mb-3 flex items-center gap-2">
                    <CheckCircle size={15} className="text-sky-500" /> Tips for
                    best OCR results
                  </p>
              ...
              <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-5 flex flex-col">
                ...
                {confidence !== null && editableText && (
                  <div className="mb-3">
                    <span
                      className={`text-xs px-2.5 py-1 rounded-full font-medium ${confidence >= 80 ? "bg-green-100 text-green-700" : confidence >= 50 ? "bg-yellow-100 text-yellow-700" : "bg-red-100 text-red-600"}`}
                    >
                      {confidence >= 80
                        ? "High"
                        : confidence >= 50
                ...
                {editableText ? (
                  ...
                  <div className="flex-1 bg-gray-50 rounded-2xl border border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-300 min-h-[320px]">
                    ...
                    <p className="text-xs text-gray-300 mt-1">
                      Clear, straight, high-contrast text works best
                    </p>
                  </div>
                )}
              </div>
          ...
          {!imageSrc && !error && (
            <div className="text-center py-16 text-gray-400 border-2 border-dashed border-gray-200 rounded-xl mt-4">
              ...
              <p>
                Drop your image above or click to browse. We'll extract text
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            How to Extract Text from Images in 3 Simple Steps
          </h2>
            ...
            {[
              {
                ...
                desc: "Drag and drop a photo, screenshot, or scanned document. JPG, PNG, WebP, BMP, and TIFF are all supported.",
              },
              {
                step: "2",
                title: "Select Language & Extract",
                desc: "Choose English, Urdu, or English + Urdu for bilingual documents. Click Extract Text and wait for the OCR engine to process.",
              },
              {
                step: "3",
                title: "Edit, Copy or Download",
                desc: "Review the extracted text in the editable area. Fix any errors, then copy to clipboard or download as a .txt file.",
              },
            ].map((item) => (
          ...
          <div className="space-y-5">
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              ...
              <div className="bg-gray-900 text-green-400 font-mono text-sm px-4 py-3 rounded-xl mb-3 overflow-x-auto">
                Tesseract.recognize(image, lang) → (text, confidence){" "}
              </div>
              <p className="text-gray-500 text-xs leading-relaxed">
                We use the open-source Tesseract OCR engine compiled to
                WebAssembly. It runs entirely in your browser, analyzing pixel
                patterns to recognize characters in your selected language.
              </p>
            </div>
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              <h3 className="font-bold text-gray-900 text-sm mb-2">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                After extraction, the tool shows a confidence score. High
                accuracy (80%+) means the text is likely correct. Lower scores
                suggest you should review the output for errors.
              </p>
            </div>
            <div className="bg-sky-50 border border-sky-100 rounded-xl p-4">
              ...
              <p className="text-sky-800 text-xs leading-relaxed">
                All OCR processing happens locally in your browser using
                JavaScript and WebAssembly. No images are uploaded, stored, or
                sent anywhere. Close the tab and your data is gone. 100% private
                by design.
              </p>
            </div>
          </div>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Real examples with different languages and image types.
          </p>
          <div className="space-y-5">
            <div className="border border-gray-100 rounded-2xl p-5">
              ...
              <div className="grid sm:grid-cols-3 gap-4 text-sm">
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Image Type</p>
            ...
            <div className="border border-gray-100 rounded-2xl p-5">
              ...
              <div className="grid sm:grid-cols-3 gap-4 text-sm">
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Image Type</p>
                  <p className="font-semibold text-gray-800">
                    Pakistani ID card photo
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Confidence</p>
                  <p className="font-semibold text-amber-600">78%</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Best For</p>
                  <p className="font-semibold text-gray-800">
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            Who Uses This OCR Tool?
          </h2>
          <p className="text-gray-500 text-sm mb-6">
            From students to professionals — extracting text saves time.
          </p>
            ...
            {[
              {
                ...
                desc: "Extract text from scanned textbooks, research papers, and lecture notes for study purposes. Edit and organize content digitally.",
              },
              {
                icon: <FileText size={20} className="text-green-600" />,
                title: "Office Professionals",
                desc: "Convert printed receipts, invoices, and forms into editable text for accounting, reporting, and data entry workflows.",
              },
              {
                icon: <Globe size={20} className="text-amber-600" />,
                title: "Content Creators",
                desc: "Pull quotes from screenshots, extract text from whiteboard photos, or digitize handwritten notes for blogs and social media.",
              },
              {
                icon: <Shield size={20} className="text-violet-600" />,
                title: "Privacy-Conscious Users",
                desc: "Extract text from sensitive documents without uploading to third-party servers. Everything stays on your device — always.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-600 mb-4 leading-relaxed">
            Most online OCR tools ask you to upload files to their servers. That
            means waiting for uploads, worrying about privacy, and sometimes
            dealing with watermarks or limits. Our free Image to Text tool works
            differently — everything happens{" "}
            <strong>inside your browser</strong> using Tesseract.js compiled to
            WebAssembly.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Especially useful for Pakistani users who need to extract text from{" "}
            <strong>Urdu and English documents</strong> — ID cards, receipts,
            books, and official forms. The "English + Urdu" language option
            handles bilingual content seamlessly.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            The extracted text appears in an editable area so you can fix any
            OCR errors before copying or downloading. Real-time word and
            character counts help you track content length. Confidence scores
            let you know when to double-check the output.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            This tool runs 100% in your browser using JavaScript and
            WebAssembly. No images are uploaded to any server. No data is stored
            or tracked. Your documents stay on your device — always.
          </p>
            ...
            {[
              {
                ...
                desc: "Compress images before OCR for faster processing.",
              },
              {
                href: "/tools/image-converter",
                title: "Image Converter",
                desc: "Convert image formats for better OCR compatibility.",
              },
              {
                href: "/tools/word-counter",
                title: "Word Counter",
                desc: "Count words and characters in your extracted text.",
              },
              {
