...
export default function LoremIpsumGenerator() {
  ...
  const totalWords = generatedText.trim()
    ? generatedText.trim().split(/\s+/).length
    : 0;
  const totalChars = generatedText.length;
  const totalSentences = generatedText.trim()
    ? generatedText.split(/[.!?]+/).filter(Boolean).length
    : 0;
      ...
      <div className="flex-grow max-w-4xl mx-auto w-full px-4 pb-20">
        ...
        <div className="text-center mb-10 mt-4">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-2xl mx-auto">
            Create customizable dummy text for wireframes, mockups and
            prototypes. Set paragraph count, word density, and HTML output.
          </p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 md:p-10 mb-8">
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-6">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setParagraphs(
                    Math.max(1, Math.min(20, parseInt(e.target.value) || 4)),
                  )
                }
                min="1"
                max="20"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setWordsPerPara(
                    Math.max(20, Math.min(300, parseInt(e.target.value) || 80)),
                  )
                }
                min="20"
                max="300"
          ...
          {!generatedText && (
            <div className="text-center py-16 text-gray-400 border-2 border-dashed border-gray-200 rounded-xl mt-4">
              ...
              <p>
                Click <strong className="text-gray-500">Generate Text</strong>{" "}
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            How to Generate Lorem Ipsum in 3 Simple Steps
          </h2>
            ...
            {[
              {
                ...
                desc: "Choose how many paragraphs you need (1-20) and words per paragraph (20-300). Toggle HTML mode if you need tagged output.",
              },
              {
                step: "2",
                title: "Generate & Preview",
                desc: "Click Generate Text. See real-time stats: word count, characters, sentences. Preview the output in a syntax-highlighted box.",
              },
              {
                step: "3",
                title: "Copy or Download",
                desc: "Copy the text to clipboard with one click, or download as a .txt file for offline use in Figma, VS Code, or your design tool.",
              },
            ].map((item) => (
          ...
          <div className="space-y-5">
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                We randomly select words from the classic Lorem Ipsum
                vocabulary, assemble them into grammatically plausible
                sentences, then group sentences into paragraphs matching your
                word count target.
              </p>
            </div>
            <div className="bg-gray-50 border border-gray-100 rounded-2xl p-5">
              ...
              <p className="text-gray-500 text-xs leading-relaxed">
                When HTML mode is enabled, each paragraph gets wrapped in
                &lt;p&gt; tags with a randomly chosen heading (&lt;h2&gt;,
                &lt;h3&gt;, or &lt;h4&gt;) before it. Perfect for pasting
                directly into code editors.
              </p>
            </div>
            <div className="bg-sky-50 border border-sky-100 rounded-xl p-4">
              ...
              <p className="text-sky-800 text-xs leading-relaxed">
                All text generation happens locally in your browser using
                JavaScript. No data is uploaded, stored, or sent anywhere. Close
                the tab and your generated text is gone. 100% private by design.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Real examples with plain text and HTML modes.
          </p>
          <div className="space-y-5">
            <div className="border border-gray-100 rounded-2xl p-5">
              ...
              <div className="grid sm:grid-cols-3 gap-4 text-sm">
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Settings</p>
                  <p className="font-semibold text-gray-800">
                    4 paras, 80 words each
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Output</p>
                  <p className="font-semibold text-gray-800">
                    ~320 words, classic opening
                  </p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3">
                  <p className="text-gray-500 text-xs mb-1">Best For</p>
                  <p className="font-semibold text-gray-800">
                    Wireframes, print mockups
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">
            Who Uses This Lorem Ipsum Generator?
          </h2>
          <p className="text-gray-500 text-sm mb-6">
            From designers to developers — placeholder text speeds up workflows.
          </p>
            ...
            {[
              {
                ...
                desc: "Fill Figma, Sketch, or Adobe XD wireframes with realistic-looking text so stakeholders focus on layout, not content.",
              },
              {
                icon: <Code size={20} className="text-green-600" />,
                title: "Frontend Developers",
                desc: "Prototype React, Vue, or vanilla JS layouts with dummy text. HTML mode outputs ready-to-paste &lt;p&gt; and &lt;h&gt; tags.",
              },
              {
                icon: <Globe size={20} className="text-amber-600" />,
                title: "Print Designers",
                desc: "Create magazine layouts, brochures, or posters with classic Lorem Ipsum that clients recognize and trust.",
              },
              {
                icon: <Shield size={20} className="text-violet-600" />,
                title: "Privacy-Conscious Users",
                desc: "Generate placeholder text without uploading to third-party servers. Everything stays on your device — always.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            Why Generate Lorem Ipsum in Your Browser?
          </h2>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Most online Lorem Ipsum generators ask you to paste settings into a
            web form that sends your request to their servers. That means
            waiting for responses, worrying about privacy, and sometimes dealing
            with ads or limits. Our free Lorem Ipsum generator works differently
            — everything happens <strong>inside your browser</strong> using pure
            JavaScript.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            Control the <strong>exact number of paragraphs</strong> and{" "}
            <strong>words per paragraph</strong> to match your design needs.
            Toggle the classic &quot;Lorem ipsum dolor sit amet...&quot; opening
            for instant recognition. Enable HTML mode to get properly structured
            &lt;p&gt; and &lt;h2&gt;-&lt;h4&gt; tags ready for your code editor.
          </p>
          <p className="text-gray-600 mb-4 leading-relaxed">
            See real-time stats: total words, characters, and sentences. Copy to
            clipboard with one click or download as a .txt file for offline use.
            No signup, no tracking, no watermarks.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            This tool runs 100% in your browser using JavaScript. No text is
            uploaded to any server. No data is stored or tracked. Your generated
            content stays on your device — always.
          </p>
        ...
        <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-10 mb-8">
          ...
          <div className="space-y-3 max-w-4xl mx-auto">
            {[
              ...
              {
                q: "Is my generated text sent to a server?",
                a: "No. All text generation happens entirely inside your browser using JavaScript. Your content never leaves your device.",
              },
            ].map((item, i) => (
              <div
                key={i}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              },
              {
                ...
                desc: "Generate realistic dummy data including text fields.",
              },
              {
