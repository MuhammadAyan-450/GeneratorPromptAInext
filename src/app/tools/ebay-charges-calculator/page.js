...
export const metadata = {
  ...
  description:
    'Calculate eBay seller fees, final value fees, and profit instantly with our free eBay Fee Calculator for sellers. 🚀',

  alternates: {
    canonical:
      'https://www.generatorpromptai.com/tools/ebay-charges-calculator',
  },

  openGraph: {
    title: 'eBay Charges Calculator – Calculate Seller Fees & Profit Free',
    description:
      'Free eBay fee calculator. Calculate final value fees, shipping costs, and net profit instantly. Adjust fee % for any category. No signup.',
  ...
  twitter: {
    ...
    description:
      'Calculate eBay seller fees, final value fees, and profit instantly with our free eBay Fee Calculator for sellers. 🚀',
    images: [
      'https://www.generatorpromptai.com/og/ebay-charges-calculator.png',
    ],
  },
  ...
  keywords:
    'ebay fee calculator, ebay charges calculator, calculate ebay seller fees, ebay final value fee calculator, ebay profit calculator, ebay shipping fee calculator, ebay selling cost estimator',
}
...
const schemaWebApp = {
  ...
  featureList:
    'Calculate final value fees, include shipping in fee calculation, customizable fee percentage, visual profit/fee breakdown, copy results, download .txt, 100% client-side privacy, no signup required',
}
